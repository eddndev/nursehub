    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div class="text-center">
                <span class="text-sm text-slate-600 dark:text-slate-400">¿Ya tienes cuenta?</span>
                <a href="{{ route('login') }}" class="text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 ml-1">
                    Iniciar sesión
                </a>
            </div>
        </form>

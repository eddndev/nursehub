...
<div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-slate-200 bg-white px-6 pb-4 dark:border-white/10 dark:bg-slate-900">
    ...
    <nav class="flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li>
                <div class="text-xs/6 font-semibold text-slate-400 dark:text-slate-500">Áreas del Hospital</div>
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    <li>
                        <x-sidebar-team-link href="#" initial="U">
                            Urgencias
                        </x-sidebar-team-link>
                    </li>
                    <li>
                        <x-sidebar-team-link href="#" initial="I">
                            UCI
                        </x-sidebar-team-link>
                    </li>
                    <li>
                        <x-sidebar-team-link href="#" initial="C">
                            Cirugía
                        </x-sidebar-team-link>
                    </li>
                    <li>
                        <x-sidebar-team-link href="#" initial="P">
                            Pediatría
                        </x-sidebar-team-link>
                    </li>
                </ul>
